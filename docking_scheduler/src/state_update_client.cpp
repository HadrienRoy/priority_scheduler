...
void SchedulerNode::stateUpdateClient(std::string id, std::string state)
{
    // Create client
    auto client = this->create_client<docking_interfaces::srv::StateUpdate>("docking_controller/state_update_service"); // TODO: add id into 
